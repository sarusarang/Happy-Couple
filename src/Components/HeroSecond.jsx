                        ...
                        <div className='row'>
                            ...
                            <div className='col-md-6 hero2-margin' onClick={HeroModalClick}>
                                ...
                                <div className=' hero2-logo'>
                                    ...
                                    <img src="/ErectaidLog-01.png" loading='lazy' className='img-fluid' alt="img" />
                            ...
                            <div className='col-md-6 mt-4' onClick={()=>{Navigate('/pro/1')}} style={{cursor:'pointer'}}>
                                ...
                                <img src="/263x263-02.jpg" loading='lazy' className='img-fluid' alt="img" />
                            ...
                            <div className='col-md-6 mt-4 hover' onClick={()=>{HeroModalClick("Lygin")}} >
                                ...
                                <div className='hero2-logo'>
                                    ...
                                    <img src="/Lygin-01.png" loading='lazy' className='img-fluid' alt="img" />
                ...
                >
                    ...
                    <Modal.Header closeButton>
                        ...
                        <div className='modal-logo'>
                            ...
                            <img src="/ErectaidLog-01.png" loading='lazy' className='img-fluid' alt="" />
